...
def main():
    ...
    for category in categories:
        categories_helper.append({'name':category, 'slug':helper.prepare_string_for_html(category)})
    ...
    accessories_generator.generate_sitemap(site_meta['domain'], PAGES, POSTS, site_meta['posts_pre_slug'])

    #generate rss feed
    print('Generating RSS feed')
    accessories_generator.generate_rss_feed(POSTS, site_meta['posts_pre_slug'], site_meta)
    ...
    image_processor.generate_responsive_images(img_from, img_destination, site_meta['image_sizes'])
